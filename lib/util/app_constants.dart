...
class AppConstants {
  ...
  static const String BASE_URL = 'http://18.134.163.223';
  ...
  static const String FORGET_PASSWORD_URI = '/api/resend_otp';
  static const String VERIFY_TOKEN_URI = '/api/v1/auth/verify-token';
  static const String RESET_PASSWORD_URI = '/api/forget_change_password';
  static const String VERIFY_PHONE_URI = '/api/otp-verify';
