            ...
            Container(
              ...
              child: Row(children: [
                ...
                Expanded(child: CustomTextField(
                  ...
                  hintText: 'phone'.tr,
                  onSubmit: (text) => GetPlatform.isWeb ? _forgetPass("+44") : null,
                )),
              ]),
            ),
      ...
      showCustomSnackBar('enter_phone_number'.tr);
        ...
        Get.find<AuthController>().forgetPassword(_numberWithCountryCode).then((status) async {
          if (status.statusCode==200) {
            //Get.toNamed(RouteHelper.getVerificationRoute(_numberWithCountryCode, '', RouteHelper.forgotPassword, status.otp));
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(builder: (context) => VerificationScreen(number:_numberWithCountryCode, password:'',fromSignUp:true,otp:status.otp)),
            );
          }else {
