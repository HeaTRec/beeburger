...
class AuthRepo {
  ...
  Future<Response> login({String contry_code, String phone, String password,String device_token,String device_type}) async {
    return await apiClient.postData(AppConstants.LOGIN_URI, { "country_code":contry_code, "phone_no": phone, "password": password,"device_token":device_token,"device_type":device_type});
  }
  ...
  Future<Response> forgetPassword(String phone) async {
    return await apiClient.postData(AppConstants.FORGET_PASSWORD_URI, {"phone_no": phone});
  }
  ...
  Future<Response> resetPassword( String number, String password) async {
    return await apiClient.postData(
      AppConstants.RESET_PASSWORD_URI,
      //{"_method": "post", "phone_no": number, "password": password},
      {"phone_no": number, "password": password},
    );
  }
  ...
  Future<Response> verifyPhone(String phone, String otp) async {
    return await apiClient.postData(AppConstants.VERIFY_PHONE_URI, {"phone_no": phone, "otp": otp});
  }
